...
\begin{tikzpicture}[scale=1.4]
  ...
  % ── N and S pole labels ────────────────────────────────────
  \node[darkblue, font=\large\bfseries] at (\xend+0.5, .13) {N};
  \node[darkblue, font=\large\bfseries] at (\xstart-.5, .13) {S};

  % ── B label ───────────────────────────────────────────────
  \node[midblue, font=\small\bfseries] at (\xmid, 0.65) {$B$};

   % Caption
  \node[darkblue, font=\small\bfseries] at (2.2,-1.9,0) {Magnetic field around a Solenoid};
