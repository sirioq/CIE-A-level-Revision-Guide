...
% ── Solution box — pale pink, used inside worked-example questions ────────────
...
\newcommand{\maketitlepage}[4]{%
  ...
  \begin{center}
    {\fontsize{14}{18}\selectfont\bfseries\color{white}
      CIE International A Level Physics (9702)}\\[8pt]
    {\fontsize{20}{26}\selectfont\bfseries\color{white} #1}\\[6pt]
    {\fontsize{28}{34}\selectfont\bfseries\color{white} #2}\\[8pt]
    {\fontsize{13}{18}\selectfont\color{white!85!cieprimary} #3}
  \end{center}
  \vspace{4.8cm}
  % Pink accent rule
