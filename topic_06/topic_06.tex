...
\begin{tikzpicture}[scale=0.85]
  ...
  \begin{scope}[xshift=-3.8cm]
    ...
    \node[midblue, font=\small] at (1.0,-0.4)  {$F$};
    \node[darkblue, font=\small] at (0,-0.85) {Tensile (extension)};
  \end{scope}
  % Compressive
  \begin{scope}[xshift=3.8cm]
    \fill[darkblue!40] (-0.4,-0.3) rectangle (0.4,0.3);
    ...
    \node[midblue, font=\small] at (-1.0,-0.4) {$F$};
    \node[midblue, font=\small] at (1.0,-0.4)  {$F$};
    \node[darkblue, font=\small] at (0,-0.85) {Compressive (compression)};
  \end{scope}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[xscale=1.5, yscale=1.1]
  ...
  \node[pinkframe, font=\small, anchor=west] at (2.55,3.4) {Limit of proportionality};

  % Gradient label
  \node[midblue, font=\small] at (0.9,2.5) {gradient $= k$};
  %\draw[->, midblue, thin] (1.3,2.3) -- (1.7,1.7);

  % Region label
  \node[midblue, font=\small] at (3.8,4.3) {non-linear};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=1.4]
  ...
  \node[white, font=\small] at (0,0.3) {$m$};
  % Length brace
  ...
  \node[pinkframe, font=\small, anchor=west] at (-2,1.1) {marker};
  % Millimetre rule (schematic)
  \draw[darkgray, thick] (-0.9,0.5) -- (-0.9,4.3);
  \foreach \y in {0.6,0.9,...,4.2}{
    \draw[darkgray] (-0.9,\y) -- (-0.75,\y);
  }
  \node[darkgray, font=\small, rotate=90, anchor=south] at (-1,2.4) {mm scale};
  % Ceiling clamp
...
\begin{tikzpicture}[xscale=2.4, yscale=1.6]
  ...
  \node[darkblue, font=\small, anchor=west] at (0.85,3.6) {elastic limit};
 ...
 % \draw[darkblue!60, very thick] (3.2,3.5) -- (3.5,2.8);
  \node[darkblue, font=\small, anchor=south west] at (3.2,3.2) {breaking point};



  % Region shading labels
  \node[darkblue!50, font=\small] at (0.4,0.4) {elastic};
  \node[darkblue!50, font=\small] at (2.2,0.4) {plastic};
  \draw[dashed, darkgray, thin] (0.95,0) -- (0.95,3.3);
  
    % Limit of proportionality
 
  \node[pinkframe, font=\small, anchor=west, fill=white] at (0.75,2.8) {limit of proportionality};
  
    % Gradient label
  \node[midblue, font=\small, fill=white] at (1,1.5) {gradient $= E$};
